...
CREATE TABLE `gameinfo` (
  `gameNumber` int(11) NOT NULL AUTO_INCREMENT,
  `playerID` int(11) DEFAULT NULL,
  `winner` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`gameNumber`),
  KEY `playerID` (`playerID`),
  CONSTRAINT `gameinfo_ibfk_1` FOREIGN KEY (`playerID`) REFERENCES `playerinfo` (`playerID`)
...
-- Dump completed on 2018-01-14 20:35:31
